...
export default function PostsListItem({post, unread}) {
  const navigate = useNavigate();
  return (
    <ListItemButton onClick={()=>{navigate(`/post/${post._id}`)}} alignItems="flex-start" sx={unread?{backgroundColor: `#828DF81f`}:{}}>
      <ListItemAvatar>
